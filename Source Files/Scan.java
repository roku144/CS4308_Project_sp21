...
public class Scan {
	...
	public static void readFile (FileReader OpenFile) {
		//String FileName = "";
		...
		/*
		*File edited from deliverable 1
		*Moved loop to gain user input to the Driver.java file and passes the open 
		*FileReader object to function via the OpenFile object parameter.
		*/
		
		//Buffer to store the data stored in the Open FileReader object
		try (BufferedReader BR = new BufferedReader(OpenFile)){
			String Line;
